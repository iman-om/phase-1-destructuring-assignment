...
// 8. Use destructuring to assign songs 2 and 4, and Kermit's job and partnerconst { song2, song4, nestedJob: kermitJob, nestedPartner: kermitPartner } = nestedMuppet.album.theMuppetMovie;
const {
  album: {
